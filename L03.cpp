...
a. Divide the coordinate axes into four quadrants and then draw only a portion of an
ellipse with the major axis as X‐axis.
b. Draw another portion of the ellipse with the major axis as Y‐axis to the quadrant
diagonally opposite to each other.
Assign different colours to them respectively.
*/
...
void display () {
	// A. PORTION OF AN ELLIPSE WITH THE MAJOR AXIS AS X-AXIS
	xCenter = 0; yCenter = 0; rx = 400; ry = 100;
    glColor3f (1.0, 0.0, 0.0);
    ellipseMidPoint (1, 0, 0, 0); // Format ellipseMidPoint (Quad1Visibility, Quad2Visibility, Quad3Visibility, Quad4Visibility) where QuadVisibility is either 0 (don't show) or 1 (show)
    
    // B. PORTION OF AN ELLIPSE WITH THE MAJOR AXIS AS Y-AXIS
	xCenter = 0; yCenter = 0; rx = 100; ry = 400;
    glColor3f (0.0, 1.0, 0.0);
    ellipseMidPoint (0, 0, 1, 0); // Format ellipseMidPoint (Quad1Visibility, Quad2Visibility, Quad3Visibility, Quad4Visibility) where QuadVisibility is either 0 (don't show) or 1 (show)
